...
public:
     ...
     * @return 数据个数
     */
    quint32 getDataNum() const { return defaultDataNum; }

    /**
     * @brief 获取当前分频系数
     * @return 分频系数
     */
    quint32 getDivider() const { return defaultDivider; }

    /**
     * @brief 获取当前通道选择
     * @return 通道选择 (0-2)
     */
    quint8 getChannel() const { return channel; }

    /**
     * @brief 获取当前波形类型
     * @return 波形类型 (0-3)
     */
    quint8 getWaveformType() const { return waveformType; }

    /**
     * @brief 获取目标IP地址
     * @return 目标IP地址
     */
    QHostAddress getTargetAddress() const { return targetAddress; }
