...
#include <memory>
#include "../../src/network/udp_send.h"
...
void UdpSender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UdpSender::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpSender::dataSent)) {
                *result = 0;
                return;
            }
        }
