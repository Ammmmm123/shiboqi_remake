...
#include <memory>
#include "../../src/data_processing/data_processor.h"
...
QT_MOC_LITERAL(9, 111, 27), // "samplingRecommendationReady"
QT_MOC_LITERAL(10, 139, 22), // "SamplingRecommendation"
QT_MOC_LITERAL(11, 162, 14), // "recommendation"
QT_MOC_LITERAL(12, 177, 17), // "setSamplingConfig"
QT_MOC_LITERAL(13, 195, 7), // "dataNum"
QT_MOC_LITERAL(14, 203, 10), // "sampleRate"
QT_MOC_LITERAL(15, 214, 5), // "reset"
QT_MOC_LITERAL(16, 220, 19) // "processWaveformData"

    },
    "DataProcessor\0analysisReady\0\0"
    "WaveformAnalysisResult\0result\0"
    "downsampledDataReady\0QVector<double>\0"
    "voltages\0times\0samplingRecommendationReady\0"
    "SamplingRecommendation\0recommendation\0"
    "setSamplingConfig\0dataNum\0sampleRate\0"
    "reset\0processWaveformData"
};
...
static const uint qt_meta_data_DataProcessor[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::UInt, QMetaType::Double,   13,   14,
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 6, 0x80000000 | 6,    7,    8,
...
void DataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->samplingRecommendationReady((*reinterpret_cast< const SamplingRecommendation(*)>(_a[1]))); break;
        case 3: _t->setSamplingConfig((*reinterpret_cast< quint32(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        ...
        {
            using _t = void (DataProcessor::*)(const SamplingRecommendation & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataProcessor::samplingRecommendationReady)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void DataProcessor::samplingRecommendationReady(const SamplingRecommendation & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
